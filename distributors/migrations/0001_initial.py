    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(auto_now_add=True, verbose_name='date when the person was added')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='user_sections', to=settings.AUTH_USER_MODEL)),
            ],
            options={
